...
use google_memcache1_beta2::{api, Error, oauth2, client::chrono, FieldMask};
...
struct Engine<'n, S> {
    opt: ArgMatches<'n>,
    hub: api::CloudMemorystoreForMemcached<S>,
    gp: Vec<&'static str>,
    ...
    S::Error: Into<Box<dyn StdError + Send + Sync>>,
{
    ...
    async fn _projects_locations_instances_upgrade(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudMemcacheV1beta2UpgradeInstanceRequest = json::value::from_value(object).unwrap();
