...
use google_cloudfunctions1::{api, Error, oauth2, client::chrono, FieldMask};
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "docker-repository" => Some(("dockerRepository", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
