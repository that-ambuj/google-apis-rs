...
async fn main() {
    ...
    let arg_data = [
        ...
        ("buckets", "methods: 'delete', 'get', 'get-iam-policy', 'insert', 'list', 'lock-retention-policy', 'operations-cancel', 'operations-get', 'operations-list', 'patch', 'set-iam-policy', 'test-iam-permissions' and 'update'", vec![
            ("delete",
